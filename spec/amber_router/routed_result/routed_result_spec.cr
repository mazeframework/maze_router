...
def terminal_segment
  Maze::Router::TerminalSegment(Symbol).new(
    :route,
    "/full/path"
  )
end
...
def found_result
  Maze::Router::RoutedResult(Symbol).new terminal_segment
end

def not_found_result
  Maze::Router::RoutedResult(Symbol).new nil
end

describe Maze::Router::RoutedResult do
  context "found?" do
